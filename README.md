...
```
> Show me the last 5 runs of the weekly-monitor cron — compact mode, just the summaries.
```
...
```
> Create a cron that runs every Friday at 1pm Paris and posts a summary to Telegram group <chat-id-redacted>.
```
